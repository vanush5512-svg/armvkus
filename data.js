...
var ARM={
  ...
  cats:function(v){return v!==undefined?(this._s('cats',v),v):this._g('cats',[{"id":1,"icon":"🥩","name":"Мясные блюда","desc":"Люля-кебаб в лаваше"},{"id":3,"icon":"🍰","name":"Выпечка","desc":""},{"id":4,"icon":"🍯","name":"Десерты","desc":"Пахлава, суджух"},{"id":5,"icon":"🥤","name":"Напитки","desc":"Кофе, тан, компоты"}])},
